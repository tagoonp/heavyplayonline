            ...
            <div class="app-layout-container">
                ...
                <main class="app-layout-content">
                  <div class="container-fluid p-y-md">
                    <div class="row">
                      <div class="col-md-12">
                        <form class="js-validation-bootstrap form-horizontal" id="postform" action="controller/insert-post-full.php"  method="post">
                            ...
                            <div class="card">
                              ...
                              <div class="card-block">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="txt-title" id="txt-title" value="" class="form-control">
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea name="txt-detail" id="txt-detail" rows="10" cols="40"  class="form-control"></textarea>
                                    </div>
                                  </div>
                              </div>
                            </div>
