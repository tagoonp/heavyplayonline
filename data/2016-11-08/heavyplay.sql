...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2016 at 04:40 AM
...
(2, 'Alienware New  13', 'The first of its kind to feature quad-core, H-class processors, the Alienware 13 has evolved to offer unprecendented graphics power with NVIDIA 10-series graphics.', 1, 1199.99, 0, 'http://i.dell.com/sites/imagecontent/app-merchandizing/responsive/LearnSegment/alienware/assets/en/PublishingImages/alienware-laptops/alienware-laptop-category-premigration-day01_Compare-1.jpg', 'Y', '2016-11-07');
...
--
ALTER TABLE `d4is_product_attribute`
  MODIFY `pa_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT for table `d4is_product_attribute_detail`
--
ALTER TABLE `d4is_product_attribute_detail`
  MODIFY `pad_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
--
-- AUTO_INCREMENT for table `d4is_product_setup`
--
ALTER TABLE `d4is_product_setup`
  MODIFY `ps_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
--
